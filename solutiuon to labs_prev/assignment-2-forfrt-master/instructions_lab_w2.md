# Lab Session for Week 2 and Assignment 2. 

The Lab Session and the assignment use the same **[notebook](lab_session_week2.ipynb)**.

## Lab Session 

During the Lab Session, read through the **[notebook](lab_session_week2.ipynb)** and complete the questions.

## Assignment Brief

### Deadline: 11:59PM on Friday Oct 12 2018

### How and what to submit

Please download the **[notebook](lab_session_week2.ipynb)** and complete the exercises. 
...
1. Being able to provide derivatives for objective functions.
2. Being able to code in Python gradient descent procedures to miminise objective functions.
